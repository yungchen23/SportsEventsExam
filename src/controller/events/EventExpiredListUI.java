...
public class EventExpiredListUI extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					EventExpiredListUI frame = new EventExpiredListUI();
...
//		club = CommonUI.club;
		...
		// ---------表格內數據----------------------
		List<Events> list = new EventsSerivceImpl().getEventsByPublish(false);
